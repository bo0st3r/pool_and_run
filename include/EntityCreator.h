...
class EntityCreator
{
    public:
        ...
        static Entity createPlayer(float x, float y, std::string name, ComponentManagerSingleton& compManager, ECSCoordinatorSingleton& ecs);
        static Entity createEnnemyBall(float x, float y, std::string name, ComponentManagerSingleton& compManager, ECSCoordinatorSingleton& ecs);
        ...
        static Entity createHole(float x, float y, ComponentManagerSingleton& compManager, ECSCoordinatorSingleton ecs);
        static Entity createEndLevel(float x, float y, ComponentManagerSingleton& compManager, ECSCoordinatorSingleton ecs);
        static Entity createTile(float x, float y, std::string name, ComponentManagerSingleton& compManager, ECSCoordinatorSingleton& ecs);
